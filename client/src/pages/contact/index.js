  ...
  return (
    <section className="contact">
      <div className="info-intro">
        ...
        {/* <h3 className="trail-line ">Contact?</h3> */}
          <p className="contact">Do you have any quetions, or want to get in contact for some reason? You can!</p>
          <ul className="contact-me">
            <li><span className="other-games-span">Ingame:</span> Sugarcube.9867</li>
            <li><span className="other-games-span">Discord:</span> Sugarcube#5024</li>
          </ul>
          <ul className="contact-me">
            <li><span className="other-games-span">Instagram</span> <a href="https://www.instagram.com/sugarcube.gw2/">Sugarcube.gw2 </a></li>
            <li><span className="other-games-span">Instagram</span> <a href="https://www.instagram.com/a_skritt_at_heart/">a_skritt_at_heart </a></li>
          </ul>
      </div>
